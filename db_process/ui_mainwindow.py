...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 879, 17))
        ...
        font = QtGui.QFont()
        font.setFamily("黑体")
        self.menuspc_figure.setFont(font)
        ...
        font = QtGui.QFont()
        font.setFamily("黑体")
        self.menuPlotFrequence.setFont(font)
        ...
        self.actionQsStatic = QtWidgets.QAction(MainWindow)
        self.actionQsStatic.setEnabled(False)
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(9)
        self.actionQsStatic.setFont(font)
        self.actionQsStatic.setObjectName("actionQsStatic")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionQsStatic.setText(_translate("MainWindow", "故障模式统计"))
