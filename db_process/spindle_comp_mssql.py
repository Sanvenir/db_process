...
from db_process.database_mssql import CompDataBase
...
class CompDataProcess(object):
    def __init__(self, select_spindle_id, start_date, end_date, text_out=print):
        self.data = {}
        self.text_out = text_out
        for spindle in select_spindle_id:
            self.data[spindle] = SingleDataProcess()
        db = CompDataBase(text_out=self.text_out)
...
class SelectDialog(QDialog):
    def __init__(self, parent=None, text_out=print):
        super().__init__(parent)
